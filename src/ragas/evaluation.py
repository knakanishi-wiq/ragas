...
def evaluate(
    ...
    # validation: this handles a slight change in column names in the generated testset
    # It ensures backward compatibility with testsets generated by older versions of RAGAS.
    ...
    row_run_managers = []
    evaluation_rm, evaluation_group_cm = new_group(name="ragas evaluation", inputs={}, callbacks=callbacks, is_async=is_async)
